            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <thead>
                    <tr class="bg-gradient-dark text-light">
                        ...
                        <th class="text-center">Bus Reg. Code</th>
                        <th class="text-center">Client</th>
                        <th class="text-center">Pickup</th>
                        <th class="text-center">Dropup</th>
                        <th class="text-center">Bus_NO</th>
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $bookings = $conn->query("SELECT b.*,cc.*,concat(c.lastname,', ', c.firstname,' ',c.middlename) as client, cab_reg_no FROM `booking_list` b inner join client_list c on b.client_id = c.id inner join cab_list cc on b.cab_id = cc.id order by unix_timestamp(b.date_created) desc ");
