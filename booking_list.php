                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <!-- <button type="button" class="btn btn-flat btn-info border btn-sm view_data" onclick="location.href='payment.php'">Pay with Cash </button>-->
                                </td>

                                <td class="text-center">
                                    <?php
                                    if ($row['status'] == 1) {
                                        echo "<button type='button' class='btn btn-flat btn-info border btn-sm view_data' onclick=\"location.href='process_payment.php'\">Pay with Cash</button>";
                                    }
                                    ?>
                                </td>
